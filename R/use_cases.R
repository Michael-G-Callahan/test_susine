...
use_case_catalog <- function() {
  tibble::tribble(
    ...
    "none",       FALSE, FALSE, "none",       TRUE,
    "b_iv", "1b", "SuSiE + functional sigma (mu=0) + auto sigma scale",
    "naive",      "functional", "none",       FALSE, TRUE,  "none",       TRUE,
    "b_v",  "1b", "SuSiNE + functional mu (sigma naive) + auto mu scale",
    "functional", "naive", "none",       TRUE,  FALSE, "none",       TRUE,
    "b_vi", "1b", "SuSiNE + functional mu (sigma EB) + auto mu scale",
    "functional", "eb_sigma", "none",       TRUE,  FALSE, "none",       TRUE,
