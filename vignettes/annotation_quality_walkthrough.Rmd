...
- `lambda_align` — how strongly the annotation aligns with the true effects (`1 = perfect`, `0 = pure noise`);
- `rho_noise` — how much extra noise is injected into non-causal SNP annotations (scaled to the effect size).
