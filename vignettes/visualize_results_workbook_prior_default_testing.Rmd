...
save_or_show(p, "power_fdr_all.png", width = 14, height = 9)
```
...
if (nrow(confusion_low) > 0) {
  ...
  save_or_show(p, "power_fdr_pstar_low.png", width = 14, height = 9)
} else {
...
if (nrow(confusion_high) > 0) {
  ...
  save_or_show(p, "power_fdr_pstar_high.png", width = 14, height = 9)
} else {
...
for (af in annotation_filters) {
  ...
  save_or_show(combined, fname, width = 16, height = 12)
}
```
