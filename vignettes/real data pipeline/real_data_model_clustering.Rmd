...
Summary: Requires saved real-data fit summaries and RSS inputs (e.g., from the real case study grid). This notebook clusters models by PIP similarity, summarizes entropy/rank correlations, and highlights SNPs consistently prioritized across clusters.
