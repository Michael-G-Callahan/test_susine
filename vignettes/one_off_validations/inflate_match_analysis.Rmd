...
Summary: Validates the `inflate_match` behavior in `simulate_priors()` using targeted simulations and (optionally) historical run outputs. It reports variance matching diagnostics and produces plots saved to `output/inflate_match_analysis_plots` when enabled.
