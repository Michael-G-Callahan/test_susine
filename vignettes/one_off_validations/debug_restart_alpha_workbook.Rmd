...
restart_rows <- run_table %>%
  filter(use_case_id == "susie_vanilla",
...
```{r alpha-sampling}
alpha_concentration <- 0.1 #job_inputs$alpha_concentration
n_samples <- 50

L <- 10#as.integer(restart_row$L)
p <- 1000 #ncol(data_bundle$X)
