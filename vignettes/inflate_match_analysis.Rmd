...
plt <- ggplot(analysis_df, aes(x = factor(inflate_match), y = var_ratio, fill = factor(annotation_r2))) +
...
plt <- ggplot(var_comparison, aes(x = factor(inflate_match), y = mu_0_var, 
                           fill = snp_type)) +
