...
# NOTE: gamma_shrink and annotation_scale are deprecated/removed.
#  - c_value replaces annotation_scale (SuSiNE prior mean scaling)
#  - tau_value is the softmax temperature for functional pi
#  - exploration_methods tracks how each fit was generated
detailed_grouping_vars <- c(
  "use_case_id", "explore_method", "agg_method",
...
dataset_grouping_vars <- c("matrix_id", "use_case_id", "explore_method", "agg_method")
```
