...
job_inputs <- list(
  ...
  # Baselines use sigma_0_2 = 0.2 only (handled by use case catalog).
  # Functional use cases get 2 levels.
  # TODO: If the harness doesn't support per-use-case sigma grids,
  # keep all 3 here and accept the extra baseline runs (~small).
