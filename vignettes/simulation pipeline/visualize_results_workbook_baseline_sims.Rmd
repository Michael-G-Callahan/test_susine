...
## 3.1 Overall screening summaries
...
## 3.2 By-annotation summaries

```{r by-annotation, fig.width=14, fig.height=8}
p_auprc_ann <- ggplot(
...
## 3.3 Family-specific screening views

```{r family-screening, fig.width=12, fig.height=8}
