...
annotation_methods <- c("susine_functional_mu", "susie_functional_pi")
...
ggsave(file.path(fig_root, "baseline_performance", "auprc_by_annotation.png"), p_ann_auprc, width = 14, height = 9, dpi = 150)
ggsave(file.path(fig_root, "baseline_performance", "tpr05_annotation_consuming.png"), p_ann_tpr, width = 14, height = 9, dpi = 150)
```
  ...
  effect_density_df <- dplyr::bind_rows(
    ...
    dplyr::mutate(
      density_label = factor(
        .data$density_label,
        levels = c("susie_vanilla", "susine_functional_mu", "susie_functional_pi")
      )
    )
